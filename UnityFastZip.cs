...
namespace TouhouMix {
	/// <summary>
	/// FastZipEvents supports all events applicable to <see cref="UnityFastZip">FastZip</see> operations.
	/// </summary>
	...
	public class UnityFastZip {
		...
		/// <summary>
		/// Initialise a default instance of <see cref="UnityFastZip"/>.
		/// </summary>
		public UnityFastZip() {
		}

		/// <summary>
		/// Initialise a new instance of <see cref="UnityFastZip"/>
		/// </summary>
		/// <param name="events">The <see cref="FastZipEvents">events</see> to use during operations.</param>
		public UnityFastZip(FastZipEvents events) {
			events_ = events;
		}
		...
		public void ExtractZip(Stream inputStream, string targetDirectory,
			...
			extractNameTransform_ = new UnityNameTransform(targetDirectory);
